            ...
            <section class="">
              <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                  <h5 class="text-uppercase custom-bg-text">HRMS All-In-One</h5>

                  <p>
                    Welcome to our all-in-one HRMS platform, where managing your
                    workforce is effortless and efficient. Empower your
                    organization with smarter HR solutions today!
                  </p>
                </div>
